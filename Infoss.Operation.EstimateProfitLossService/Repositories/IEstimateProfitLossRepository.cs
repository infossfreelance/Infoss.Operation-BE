...
namespace Infoss.Operation.EstimateProfitLossService.Repositories
{
    public interface IEstimateProfitLossRepository
    {
        ...
        public Task<PageSetResponse<ShippmentListByIdResponse>> GetShipmentOrderListByIdRepository(int CountryId, int CompanyId, int BranchId, int flag,int ShippingId);
